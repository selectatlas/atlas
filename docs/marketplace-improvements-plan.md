...
### 1. [ ] Verified badge on search cards and shortlist rows
...
### 2. [ ] Profile completeness meter + checklist modal on talent home
...
### 4. [ ] Empty-search suggestion chips (demo insurance)
...
### 5. [ ] Saved searches + new-match alerts for hirers
...
### 6. [ ] Job pipeline stepper + stage tabs on job detail
...
### 7. [ ] Structured system cards in message threads
...
### 8. [ ] "Your move" pill + pre-hire timeline in the context rail
...
### 9. [ ] In-app review authoring (two-stage)
...
### 11. [ ] Monetization surfaces (mockup-grade)
...
### 12. [ ] Notifications bell dropdown
