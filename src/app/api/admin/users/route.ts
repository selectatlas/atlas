...
export async function GET(request: Request) {
  ...
  if (roleFilter === 'admin') {
    ...
    let query = auth.service
      .from('profiles')
      .select('id, account_type, full_name, email, city, country, suspended_at, suspension_reason, profile_visibility, verified_at, verified_categories, membership_tier, created_at')
      .in('id', adminIds)
      .order('created_at', { ascending: false })
