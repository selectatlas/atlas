...
function Button({
  ...
  return (
    <ButtonPrimitive
      data-slot="button"
      className={cn(
        /* CRISP: scale(0.97) press confirmation. No transition-all — animate only transform & opacity. */
        "transition-[transform,opacity] duration-[var(--duration-fast)] ease-[var(--ease-out)] active:scale-[0.97]",
