...
export const PUBLIC_PROFILE_FIELDS =
  'id, account_type, full_name, avatar_url, cover_url, headline, city, country, bio, rates, availability, showreel_url, profile_visibility, created_at' as const
...
export const PUBLIC_PROFILE_WITH_SKILLS =
  'id, account_type, full_name, avatar_url, cover_url, headline, city, country, bio, rates, availability, showreel_url, profile_visibility, created_at, talent_skills(id, profile_id, category, skill, proficiency, created_at)' as const
