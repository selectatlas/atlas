...
import { mirrorImageToStorage, seededCategoryCoverUrl, seededJobCoverUrl, seededPortfolioImageUrl } from './images'
...
export const DEMO_JOBS: DemoJob[] = [
  ...
  {
    key: 'arena_tour_dancers',
    title: 'Hip-Hop Dancers — UK Arena Tour Opening Act',
    description:
      'Casting six hip-hop and street dancers to open a 12-date UK arena tour supporting a chart headliner. Rehearsals run for two weeks in Manchester before the tour bus rolls; accommodation and per diems covered on the road. We want big, confident battle-ready energy - popping, locking, and breaking vocabulary all welcome. Tour experience is a plus but attitude and stage presence matter more.',
    category: 'dancer',
    skills_required: ['Hip-hop', 'Street dance', 'Popping & locking'],
  ...
  {
    key: 'latin_showcase',
    title: 'Latin Dance Couples — "Noche de Fuego" Theatre Showcase',
    description:
      'A touring Latin dance production is recasting two couples for its Birmingham residency. Strong salsa and bachata partner work is essential; ballroom polish helps for the ensemble numbers. Three-week run with two shows on Saturdays, full costume and choreography provided. We hold couples auditions but individual applications are welcome - we will match partners at the recall.',
    category: 'dancer',
    skills_required: ['Salsa', 'Bachata', 'Ballroom'],
    ...
    endInDays: 63,
    deadlineInDays: 21,
    duration: '3-week run, 8 shows per week',
    usage_rights: 'Show promotion + venue social',
    travel_required: false,
  },
  {
    key: 'kpop_video',
    title: 'K-pop Style Dancers — Girl Group Debut Music Video',
    description:
      'A UK-based girl group is shooting their debut music video and needs four backing dancers fluent in K-pop choreography styles. Sharp synchronised formations, waacking accents, and quick pickup from video references are the core of the job. One day of rehearsal, one long shoot day on a lit studio set in North London. Meals and travel within London covered.',
    category: 'dancer',
    skills_required: ['K-pop', 'Waacking', 'Jazz'],
    location: 'London, UK',
    budget: '£220 per day',
    status: 'open',
    work_type: 'in_person',
    ...
    endInDays: 19,
    deadlineInDays: 9,
    duration: '1 rehearsal day + 1 shoot day',
    usage_rights: 'Music video + artist social, in perpetuity',
    travel_required: false,
  },
  {
    key: 'comedy_commercial',
    title: 'Comedic Lead — National Supermarket Christmas Advert',
    description:
      'National supermarket chain is casting the comedic lead for this year\'s Christmas TV advert, playing age 35-55, any gender. The spot is built on warm physical comedy - think exasperated parent versus an increasingly chaotic Christmas dinner. Two shoot days in Leeds with a top commercial director; strong improvisation encouraged on set. Broadcast, VOD, and social usage across the UK for one year.',
    category: 'actor',
    skills_required: ['Comedy', 'Television acting', 'Improvisation'],
    location: 'Leeds, UK',
    budget: '£650 per day',
    status: 'open',
    work_type: 'in_person',
    ...
    endInDays: 26,
    deadlineInDays: 11,
    duration: '2 shoot days + wardrobe fitting',
    usage_rights: 'UK broadcast, VOD, and social, 12 months',
    travel_required: false,
  },
  {
    key: 'animation_voice',
    title: 'Voice Actor — Animated Children\'s Series (Recurring Role)',
    description:
      'An animation studio is casting the recurring voice of a mischievous dragon sidekick for a children\'s streaming series. We need genuine character range - the part swings from squeaky excitement to booming mock-menace, often within a single line. Recording is fully remote from your own booth or our partner studios; sessions are booked in half-day blocks, roughly two per month across the season.',
    category: 'actor',
    skills_required: ['Voice acting', 'Animation voice', 'Character work'],
    location: 'Remote, UK',
    budget: '£350 per session',
    status: 'open',
    work_type: 'remote',
    createdDaysAgo: 6,
    startInDays: 28,
    endInDays: 210,
    deadlineInDays: 18,
    duration: '2 half-day sessions per month, 6-month season',
    usage_rights: 'Worldwide streaming, all seasons of the show',
    travel_required: false,
  },
  {
    key: 'immersive_theatre',
    title: 'Immersive Theatre Cast — Victorian Murder Mystery Experience',
    description:
      'A long-running immersive murder mystery experience in a converted Shoreditch warehouse is expanding its cast. Performers stay in character for 90-minute shows while guests roam, interrogate, and derail scenes - so rock-solid improvisation and crowd control matter as much as period performance. Four to six shows per week on a rolling monthly contract, evenings and weekends.',
    category: 'actor',
    skills_required: ['Immersive theatre', 'Improvisation', 'Character work'],
    location: 'London, UK',
    budget: '£180 per show',
    status: 'open',
    work_type: 'in_person',
    ...
    startInDays: 14,
    deadlineInDays: 10,
    duration: 'Rolling monthly contract, 4-6 shows per week',
    usage_rights: 'Show promotion photography only',
    travel_required: false,
  },
  {
    key: 'mv_cinematographer',
    title: 'Cinematographer — Neo-Soul Music Video, One-Take Concept',
    description:
      'Independent label seeks a cinematographer to shoot a one-take neo-soul music video through a Bristol nightclub. The concept lives or dies on confident Steadicam-style movement and fast lighting instincts as the camera moves between five pre-lit zones. You will work directly with the director across a prep day, a full rehearsal day with the artist, and one overnight shoot.',
    category: 'photographer_videographer',
    skills_required: ['Cinematography', 'Music videos', 'Commercial videography'],
    location: 'Bristol, UK',
    budget: '£500 per day',
    status: 'open',
    work_type: 'in_person',
    ...
    endInDays: 22,
    deadlineInDays: 13,
    duration: '1 prep day + 1 rehearsal day + 1 overnight shoot',
    usage_rights: 'Music video + label social, in perpetuity',
    travel_required: false,
  },
  {
    key: 'drone_highlands',
    title: 'Drone Operator — Whisky Brand Film, Scottish Highlands',
    description:
      'Premium whisky brand film needs a licensed drone operator for four days of aerial photography across Speyside and the Cairngorms. Expect coastal cliff reveals, low tracking shots over barley fields, and tight distillery flyovers - A2 CofC minimum, GVC preferred, with your own insured rig. Travel, accommodation, and meals covered from any UK base.',
    category: 'photographer_videographer',
    skills_required: ['Drone', 'Aerial', 'Cinematography'],
    ...
    endInDays: 36,
    deadlineInDays: 16,
    duration: '4 shoot days + travel days',
    usage_rights: 'Worldwide, all media, 3 years',
    travel_required: true,
  },
  {
    key: 'fitness_creator',
    title: 'Fitness Content Creator — Gym Chain January Campaign',
    description:
      'National gym chain is booking a fitness creator to front its January reset campaign. Deliverables: eight vertical workout videos shot in our Manchester flagship plus four weeks of co-created posts on your own channels. We want realistic, encouraging training content - progress over perfection - and an engaged UK audience in the 20-45 range. Creative freedom on format within brand guardrails.',
    category: 'content_creator',
    skills_required: ['Fitness content', 'Short-form video', 'Brand partnerships'],
    location: 'Manchester, UK',
    budget: '£300 per day',
    status: 'open',
    work_type: 'hybrid',
    ...
    endInDays: 52,
    deadlineInDays: 14,
    duration: '3 shoot days + 4 weeks of posting',
    usage_rights: 'Brand social + in-gym screens, 12 months',
    travel_required: false,
  },
  {
    key: 'travel_series',
    title: 'Travel Content Creator — "Hidden Britain" Rail Series',
    description:
      'A rail operator is commissioning a six-episode short-form series uncovering overlooked UK destinations reachable by train. You will plan, shoot, and edit one episode per fortnight - each a 3-5 minute film plus vertical cutdowns - travelling on a free all-network pass with a production budget per trip. Strong storytelling voice and a proven travel back catalogue essential; editing handled end-to-end by you.',
    category: 'content_creator',
    skills_required: ['Travel content', 'Long-form video', 'Copywriting'],
    location: 'UK-wide',
    budget: '£750 per episode',
    status: 'open',
    work_type: 'hybrid',
    createdDaysAgo: 9,
    startInDays: 21,
    endInDays: 105,
    deadlineInDays: 15,
    duration: '6 episodes over 12 weeks',
    usage_rights: 'Operator channels + paid social, 24 months',
    travel_required: true,
  },
  {
...
export async function seedDemoWorld(supabase: SupabaseClient, ids: ProfileIdByEmail, assetOrigin: string): Promise<void> {
  ...
  for (const job of DEMO_JOBS) {
    // Covers are mirrored into platform storage (CSP only allows storage
    // images); a failed mirror leaves cover_url null and the UI falls back
    // to a category gradient.
    const coverUrl = await mirrorImageToStorage(supabase, {
      bucket: 'covers',
      path: `jobs/${job.key}.jpg`,
      sourceUrl: seededJobCoverUrl(`atlas-job-${job.key}`),
    })
